...
// Route mới: Xoá nhiều khóa học cùng lúc
router.post('/delete-multiple', courseControllers.deleteMultiple);
...
router.post('/restore-multiple', courseControllers.restoreMultiple);
router.post('/delete-multiple-force', courseControllers.forceDeleteMultiple);
